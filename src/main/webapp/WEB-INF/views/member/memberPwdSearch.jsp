...
<body>
	...
	<div class="container">
		<h2>비밀번호 찾기</h2>
		<p>아이디와 이메일 주소를 입력 후 메일로 임시 비밀번호를 발급 받으세요.</p>
			...
			<table class="table table-bordered">
				...
				<tr>
					<td colspan="2" class="text-center">
						...
						<input type="reset" value="다시입력" class="form-danger"/>
						<input type="button" value="돌아가기" onclick="location.href='${ctp}/member/memberLogin';" class="form-info"/>
					</td>
				</tr>
			</table>
		</form>
